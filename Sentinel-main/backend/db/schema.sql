...
CREATE TABLE IF NOT EXISTS orders (
    ...
    unit_cost           NUMERIC(10,2),            -- cost basis for financial impact estimation
...
CREATE TABLE IF NOT EXISTS exceptions (
    ...
    root_cause_category         TEXT,             -- see migration_005
    root_cause_category_source  TEXT,
    estimated_financial_impact  NUMERIC(12,2),     -- see migration_006
    financial_impact_breakdown  JSONB,
    financial_impact_explanation TEXT,
    financial_impact_computed_at TIMESTAMPTZ
);
